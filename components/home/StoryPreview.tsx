...
export default function StoryPreview() {
  return (
    <Card className="mt-5">
      ...
      <div className="relative min-h-[360px] overflow-hidden rounded-2xl border border-orange-500 bg-black p-5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_50%,rgba(249,115,22,0.55),transparent_40%)]" />
        ...
        <div className="relative z-10 max-w-[52%]">
          <p className="text-xs font-black tracking-[0.35em] text-orange-500">
            BESTGYMSMALTA
          </p>
          ...
          <p className="mt-3 text-5xl font-black text-orange-500">78 MIN</p>
          ...
          <p className="mt-6 text-lg font-black">
            Be the Best...
            <br />
            <span className="text-orange-500">Beat the Rest</span>
          </p>
        </div>
      </div>
    </Card>
