...
export default function StaffLoginPage() {
  ...
  const canManageMemberships =
    ...
    user.permissions.includes("members.renew");
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <header className="flex flex-wrap items-start justify-between gap-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {user.isSuperAdmin ? "SUPER ADMIN" : "GYM STAFF"}
            </span>
            <button
              onClick={logout}
        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-zinc-600">
            {user.isSuperAdmin
              ? "Super Admin can also use the management portal for network-wide tools."
              : "This shared gym login uses the fixed Gym Staff operational role."}
          </p>
        </section>
